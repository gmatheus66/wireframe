...
public class JogarFacil extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogar_facil);
        ...
        for(int i = 0; i < 3; i++) {
            TableRow row = new TableRow(JogarFacil.this);
            for(int j = 0; j < 2; j++) {
                ImageButton image = new ImageButton(JogarFacil.this);
