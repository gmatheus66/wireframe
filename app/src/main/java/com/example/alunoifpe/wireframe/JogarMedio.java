...
public class JogarMedio extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogar_medio);
        ...
        for(int i = 0; i < 4; i++) {
            TableRow row = new TableRow(JogarMedio.this);
            for(int j = 0; j < 3; j++) {
                ImageButton image = new ImageButton(JogarMedio.this);
